      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <p className="app-page-lead mt-2 text-base sm:text-lg">
            ตรวจรายการและนำไปออกใบเสนอราคาได้ทันที
          </p>
        </div>
        {items.length > 0 ? (
          <button
        ...
        <>
          ...
          <section className="app-card p-5 sm:p-6">
            <div className="space-y-2 text-base">
              ...
              <div className="flex justify-between gap-4">
                <span className="text-[var(--muted)]">ค่าขนส่งรวม (ตามกติกาแถว)</span>
          ...
          {hasOverStock ? (
            <p className="rounded-2xl border border-amber-200 bg-amber-50/90 px-4 py-3 text-sm text-amber-950 sm:text-base">
              กรุณาแก้จำนวนให้ไม่เกินสต็อก หรือลดรายการ ก่อนนำไปออกใบ
            </p>
          ) : null}
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center">
            ...
            {hasOverStock ? (
              ...
              <Link href="/sales/new?fromCart=1" className="app-btn-primary text-center sm:inline-block">
                นำรายการไปสร้างใบเสนอราคา
              </Link>
            )}
          </div>
